...
function renderReport(payload, partials) {
  ...
  const substitutions = {
    ...
    POSITIONING_PRIMARY: escapeHtml(candidate.positioning_primary || 'PhD Systems Engineer'),
    POSITIONING_SECONDARY: escapeHtml(candidate.positioning_secondary || 'ML Infrastructure'),
    POSITIONING_YEAR: escapeHtml(candidate.positioning_year || '2027'),
