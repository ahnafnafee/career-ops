...
1. **Identify targets** via WebSearch:
   ...
   - Assigned recruiter
   - 2-3 peers from the team (people in similar roles)
...
2. **Classify contact type** -- ask the candidate or infer from context:
   - **Recruiter** -- a person whose role is talent acquisition, sourcing, or recruiting
   - **Hiring Manager** -- the person who leads the hiring team
   - **Peer** -- someone with a similar role on the team (indirect referral)
   - **Interviewer** -- someone who is going to interview the candidate (date known)
...
4. **Generate message** using a 3-sentence framework adapted to the contact type:
   ...
   ### Hiring Manager
   - **Sentence 1 (Hook)**: A specific challenge their team is facing (extracted from the JD, company blog, or news)
