...
12. Generate full HTML from template + customized content
...
**NEVER add skills the candidate doesn't have. Only reformulate real experience using the exact JD vocabulary.**

## HTML Template

Use the template in `cv-template.html`. Replace the `{{...}}` placeholders with customized content:
...
| `{{SUMMARY_TEXT}}` | Summary customized with keywords |
