import { LayoutDashboard, Compass, ListChecks, Layers3, Send, Radar, BarChart3, FileText, Settings } from "lucide-react";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/campaign", label: "Packet review", icon: Layers3 },
